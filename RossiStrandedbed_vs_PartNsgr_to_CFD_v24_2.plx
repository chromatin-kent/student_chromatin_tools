...
# such as a TSS of gene.
# Modified : Nick Kent 14th Nov 2024 - changed Posix date stamp to perl localtime() so that script will run on both
# linux and Windows machines.

# USAGE:- perl RossiStrandedbed_vs_PartNsgr_to_CFD_v24_2.plx
#
# FUNCTION:
# This script takes .bed files containing a list of Rossi et al., 2021 ChIP-Exo_seq factor positions ("sites")  
# which have been given strand-specific designations using Rossi_interval_strand_caller_vxxx.plx and compares it with 
...
$datestring =~ tr/:/-/;
print "\n\n*************************************************";
print "\n STRANDED Rossi .bed plus PartN .sgr -> CFD graph data";
print "\n*************************************************\n";
