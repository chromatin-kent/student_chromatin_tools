...
# the same strand as the genes they are associated with. This script will help you do that.
#
...
#
# The new .bed file can them be used as input to Stranded_Rossi_CFD_plotter.plx
# 
...
# define outfile name and set ending to .bed
		$interval_outfile_name = substr($infile_peak,0,-4)."_mRNA_TSS_strand";
