...
#
# This script converts Rossi et al., .bed files into .sgr format for input into a CFD plotter.
...
# 
# 2.Any number of standard Rossi et al., .bed files describing the factors you are trying to match to the "target"/
#
# The Script .sgr format file listing the matches where Rossi peaks fall within .sgr file bins. The scripy also
