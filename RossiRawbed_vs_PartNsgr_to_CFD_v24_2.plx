...
# Modified: Nick Kent 12th Nov 2024 - sorts the .sgr filnames according to descending PartN to
...
# USAGE:- perl RossiRawbed_vs_PartNsgr_to_CFD_v24_2.plx
#
# FUNCTION:
# This script takes raw (no strand info) .bed files containing a list of Rossi et al., 2021
# ChIP-Exo_seq factor positions ("sites") and compares it with 
...
# columns format. This data is easier to plot landscape/surface graphs using Excel or R.
#
...
$datestring =~ tr/:/-/;
print "\n\n************************************************";
print "\n Raw Rossi .bed plus PartN .sgr -> CFD graph data";
print "\n************************************************\n";
